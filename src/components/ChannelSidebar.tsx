...
import type { LiveStream } from "@/services/iptv";
...
export function ChannelSidebar({ channels, activeId, onSelect }: ChannelSidebarProps) {
  return (
    <aside className="w-full lg:w-80 lg:shrink-0 rounded-lg bg-card border border-border/50 overflow-hidden">
