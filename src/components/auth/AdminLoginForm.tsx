...
interface AdminLoginFormProps {
  dnsUrl: string;
  setDnsUrl: (value: string) => void;
  adminPassword: string;
  setAdminPassword: (value: string) => void;
}

export const AdminLoginForm = ({ dnsUrl, setDnsUrl, adminPassword, setAdminPassword }: AdminLoginFormProps) => {
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <label className="text-[11px] font-black text-white uppercase tracking-[0.4em] ml-1">URL do Servidor (DNS)</label>
        <div className="relative group">
          ...
          <input
            ...
            className="w-full bg-white/[0.08] border border-white/20 rounded-2xl py-4 pl-12 pr-4 text-white placeholder:text-white/30 focus:outline-none focus:ring-2 focus:ring-purple-600/40 focus:border-purple-500/60 transition-all font-black text-[14px]"
