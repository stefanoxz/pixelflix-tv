...
export const UserLoginForm = ({ dnsUrl, setDnsUrl, username, setUsername, password, setPassword }: UserLoginFormProps) => {
  return (
    <div className="space-y-5">
      <div className="space-y-2">
        <label className="text-[11px] font-black text-white uppercase tracking-[0.4em] ml-1">Servidor</label>
